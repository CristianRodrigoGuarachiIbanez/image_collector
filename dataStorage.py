...
class DataStorage:
    T: TypeVar = TypeVar('T', List[ndarray], List[Dict[str, int]], ndarray)
    @staticmethod
    def storeData(pickelFileName: str, data: T,  mode: str = 'ab') -> None:
        ...
        with open(pickelFileName, mode) as file:
            ...
            file.close()
    @staticmethod
    def loadData(pickelFileName: str, mode: str = 'rb') -> None:
        with open(pickelFileName,mode ) as file:
            data: List= load(file);
